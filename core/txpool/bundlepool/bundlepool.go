...
func (p *BundlePool) Init(gasPrice *big.Int, head *types.Header) error {
	return nil
}
...
func (p *BundlePool) SetGasPrice(gasPrice *big.Int) {}
...
func (p *BundlePool) Pending(minTip *big.Int, baseFee *big.Int) map[common.Address]types.Transactions {
	return nil
}
...
func (p *BundlePool) Content() (map[common.Address]types.Transactions, map[common.Address]types.Transactions) {
...
func (p *BundlePool) ContentFrom(addr common.Address) (types.Transactions, types.Transactions) {
