...
var (
	PrecompiledAddressesEmerald    []common.Address
...
func init() {
	...
	for k := range PrecompiledContractsEmerald {
		PrecompiledAddressesEmerald = append(PrecompiledAddressesEmerald, k)
	}
}
...
func ActivePrecompiles(rules params.Rules) []common.Address {
	...
	case rules.IsEmerald:
		return PrecompiledAddressesEmerald
