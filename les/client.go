...
import (
	...
	"github.com/morph-l2/go-ethereum/les/downloader"
	"github.com/morph-l2/go-ethereum/les/vflux"
	vfc "github.com/morph-l2/go-ethereum/les/vflux/client"
	"github.com/morph-l2/go-ethereum/light"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightEthereum, error) {
	...
	if config.OverrideMorph300Time != nil {
		overrides.Morph300Time = config.OverrideMorph300Time
	}
