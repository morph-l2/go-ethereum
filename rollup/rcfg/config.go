...
var (
	...
	InflationMintedEpochsSolt0 = common.BigToHash(big.NewInt(108))
	...
	RewardStartedSlot0   = common.BigToHash(big.NewInt(151))
	RewardStartTimeSlot0 = common.BigToHash(big.NewInt(152))
