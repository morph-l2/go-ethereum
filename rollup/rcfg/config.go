...
var (
	...
	InflationMintedEpochsSolt0 = common.BigToHash(big.NewInt(9))
	...
	RewardStartedSlot0   = common.BigToHash(big.NewInt(3))
	RewardStartTimeSlot0 = common.BigToHash(big.NewInt(4))
