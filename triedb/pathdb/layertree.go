...
func (tree *layerTree) add(root common.Hash, parentRoot common.Hash, block uint64, nodes dbtypes.KvMap) error {
	...
	l := parent.update(root, parent.stateID()+1, block, nodes.Flatten())
